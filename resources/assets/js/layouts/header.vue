                                ...
                                <li>
                                    <div class="dw-user-box">
                                        ...
                                        <div class="u-text">
                                            ...
                                            <p class="text-muted">{{getAuthUser('email')}}</p><router-link to="/admin/profile" class="btn btn-rounded btn-danger btn-sm">View Profile</router-link></div>
                                    </div>
                                </li>
                                <li role="separator" class="divider"></li>
                                <li><router-link to="/admin/profile"><i class="fa fa-user"></i> My Profile</router-link></li>
                                <li role="separator" class="divider"></li>
                                <li><router-link to="/admin/configuration"><i class="fa fa-cogs"></i> Configuration</router-link></li>
                                <li role="separator" class="divider"></li>
